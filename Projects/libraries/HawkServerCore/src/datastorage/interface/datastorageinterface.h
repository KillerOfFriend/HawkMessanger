...
public:
     ...
     */
    virtual errors::error_code open() = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code addUser(const std::shared_ptr<hmcommon::HMUserInfo> inUser) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code updateUser(const std::shared_ptr<hmcommon::HMUserInfo> inUser) = 0;
     ...
     */
    virtual std::shared_ptr<hmcommon::HMUserInfo> findUserByUUID(const QUuid& inUserUUID, errors::error_code& outErrorCode) const = 0;
     ...
     * @return Вернёт указатель на экземпляр пользователя или nullptr
     */
    virtual std::shared_ptr<hmcommon::HMUserInfo> findUserByAuthentication(const QString& inLogin, const QByteArray& inPasswordHash, errors::error_code& outErrorCode) const = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code removeUser(const QUuid& inUserUUID) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code setUserContacts(const QUuid& inUserUUID, const std::shared_ptr<std::set<QUuid>> inContacts) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code addUserContact(const QUuid& inUserUUID, const QUuid& inContactUUID) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code removeUserContact(const QUuid& inUserUUID, const QUuid& inContactUUID) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code clearUserContacts(const QUuid& inUserUUID) = 0;
     ...
     */
    virtual std::shared_ptr<std::set<QUuid>> getUserContactList(const QUuid& inUserUUID, errors::error_code& outErrorCode) const = 0;
     ...
     */
    virtual std::shared_ptr<std::set<QUuid>> getUserGroups(const QUuid& inUserUUID, errors::error_code& outErrorCode) const = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code addGroup(const std::shared_ptr<hmcommon::HMGroupInfo> inGroup) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code updateGroup(const std::shared_ptr<hmcommon::HMGroupInfo> inGroup) = 0;
     ...
     */
    virtual std::shared_ptr<hmcommon::HMGroupInfo> findGroupByUUID(const QUuid& inGroupUUID, errors::error_code& outErrorCode) const = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code removeGroup(const QUuid& inGroupUUID) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code setGroupUsers(const QUuid& inGroupUUID, const std::shared_ptr<std::set<QUuid>> inUsers) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code addGroupUser(const QUuid& inGroupUUID, const QUuid& inUserUUID) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code removeGroupUser(const QUuid& inGroupUUID, const QUuid& inUserUUID) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code clearGroupUsers(const QUuid& inGroupUUID) = 0;
     ...
     */
    virtual std::shared_ptr<std::set<QUuid>> getGroupUserList(const QUuid& inGroupUUID, errors::error_code& outErrorCode) const = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code addMessage(const std::shared_ptr<hmcommon::HMGroupInfoMessage> inMessage) = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code updateMessage(const std::shared_ptr<hmcommon::HMGroupInfoMessage> inMessage) = 0;
     ...
     */
    virtual std::shared_ptr<hmcommon::HMGroupInfoMessage> findMessage(const QUuid& inMessageUUID, errors::error_code& outErrorCode) const = 0;
     ...
     */
    virtual std::vector<std::shared_ptr<hmcommon::HMGroupInfoMessage>> findMessages(const QUuid& inGroupUUID, const hmcommon::MsgRange& inRange, errors::error_code& outErrorCode) const = 0;
     ...
     * @return Вернёт признак ошибки
     */
    virtual errors::error_code removeMessage(const QUuid& inMessageUUID, const QUuid& inGroupUUID) = 0;
